    ...
    return (
        <header>
            <nav className={`${styles.headerContainer}`}>
                <div className={`${styles.navPc} ${navOpen ? styles.navOpen : styles.navClose}`}>
                    <div className={`${styles.headerLeft}`}>
                        ...
                        <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
                            <g fill="none" fill-rule="evenodd">
                                <path
                                    ...
                                    fill="var(--t-btn-dark-mode)" fill-rule="nonzero"/>
                                <g>
                        ...
                        <li onClick={test}>
                            {navOpen ?
                                ...
                                :
                                <svg className={`${styles.headerHamburger}`} xmlns="http://www.w3.org/2000/svg"
                                     width="18" height="15">
                                    <path fill="#242A45" fill-rule="evenodd"
                    ...
                    <ul className={`${styles.headerRight}`}>
                        <li><a className={"aNavigation"} href="#">Features</a></li>
                        <li><a className={"aNavigation"} href="#">Pricing</a></li>
                        <li><a className={"aNavigation"} href="#">Contact</a></li>
                        <button className="btn-primary-red">Login</button>
                        <ToggleDarkMode
                            isDark={isDark}
